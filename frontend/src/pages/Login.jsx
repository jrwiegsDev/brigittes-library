      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to manage your library and blog
          </p>
        </div>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm"
